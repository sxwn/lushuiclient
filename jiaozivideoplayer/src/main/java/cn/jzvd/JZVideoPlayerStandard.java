...
public class JZVideoPlayerStandard extends JZVideoPlayer {
    ...
    public void init(Context context) {
        ...
        battery_level.setVisibility(View.GONE);
    ...
    @Override
    public void onStatePreparingChangingUrl(String url, int seekToInAdvance) {
        super.onStatePreparingChangingUrl(url, seekToInAdvance);
