package com.lushuitv.yewuds.view.mzbanner;
...
import com.lushuitv.yewuds.view.mzbanner.transformer.CoverModeTransformer;
import com.lushuitv.yewuds.view.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private int []mIndicatorRes= new int[]{R.drawable.indicator_normal_icon,R.drawable.indicator_selected_icon};
